      ...
      <div className="flex flex-wrap items-start justify-between gap-4 mb-5">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            {po.agency_org?.name || 'Unassigned agency'} · {new Date(po.po_date).toLocaleDateString('en-IN')} · {fulfillmentTypeLabel(po.fulfillment_type)}
          </p>
        </div>
          ...
          <div>
            <Card className="p-5">
              ...
              <dl className="space-y-2 text-sm">
                ...
                <div className="flex justify-between"><dt className="text-slate-400">Fulfillment</dt><dd className="text-slate-700">{fulfillmentTypeLabel(po.fulfillment_type)}</dd></div>
